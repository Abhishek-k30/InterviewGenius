...
>
  <div class="space-y-1.5 bg-gray-900 dark:bg-gray-800 p-6 flex flex-col items-center gap-4">
    <span class="relative flex shrink-0 overflow-hidden rounded-full w-20 h-20">
      <img class="aspect-square h-full w-full object-contain" alt="Abhishek" src="/myPic.jpg" />
    </span>
    <div class="text-center">
      <h3 class="text-xl font-bold text-white">Abhishek Kumar</h3>
  ...
  <div class="p-6 grid gap-4">
    <div class="prose prose-invert prose-sm">
      <p class="text-black">
      As a full-stack developer with over 3 years of experience, I excel in building modern, responsive web applications. My expertise lies in JavaScript, React, Next.js, Node.js, Express.js, and MongoDB. I am proficient in creating intuitive and visually appealing user interfaces and possess strong problem-solving skills, ensuring efficient and effective solutions for complex challenges.
    ...
    <div class="flex justify-center gap-4">
      <a
        href="https://github.com/Abhishek-k30"
      ...
      <a href="https://www.linkedin.com/in/abhishek-kumar-86b82b223/ "
