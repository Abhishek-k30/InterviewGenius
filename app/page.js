    ...
    <div>
      ...
      <section className=" z-50">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            <span className="text-xs bg-primary rounded-full text-white px-4 py-1.5 mr-3">New</span> <span className="text-sm font-medium">InterviewGenius</span>
      ...
      <div className="flex justify-center items-center">
        <footer className="mb-5">
          <span className="text-gray-900 text-lg ">Created By <span className="text-pink-800 font-medium cursor-pointer"><a href="https://www.linkedin.com/in/abhishek-kumar-86b82b223/">Abhishek Kumar</a></span> | 2024 All rights reserved.</span>
        </footer>
      </div>
    </div>
